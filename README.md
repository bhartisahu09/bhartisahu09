...
### 🔧 Technologies and Tools:
[![My Skills](https://skillicons.dev/icons?i=dart,flutter,firebase,androidstudio,vscode,i=java,kotlin,nodejs,figma&theme=light,html,css,js,react,mongodb,bash,git,github,gradle,npm,postman,linux,&theme=dark)](https://skillicons.dev)
